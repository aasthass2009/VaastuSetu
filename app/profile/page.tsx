    ...
    <div className="min-h-screen bg-cream-200">
      ...
      <div className="bg-brand-indigo px-4 py-10 sm:px-6 sm:py-12">
        <div className="mx-auto max-w-3xl flex items-center gap-4">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-brand-gold/20 font-heading text-xl font-semibold text-brand-gold ring-4 ring-brand-gold/30 sm:h-16 sm:w-16 sm:text-2xl">
            {initials}
          </div>
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 truncate font-body text-sm text-cream-300">
