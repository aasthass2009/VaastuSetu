      ...
      <section className="bg-brand-indigo px-6 py-20 text-center md:py-28">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="font-body text-lg leading-relaxed text-cream-300">
            Honest answers to the questions we hear most often — from whether
            you need to break walls, to how Vastu applies abroad.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-16">
        <div className="mx-auto max-w-3xl rounded-2xl bg-brand-indigo px-8 py-10 text-center">
          ...
          <h3 className="mb-4 font-heading text-2xl font-semibold text-cream-200">
            Ask our AI Vastu Guru
          </h3>
          <p className="mb-6 font-body text-sm leading-relaxed text-cream-300">
            The chat widget in the bottom-right corner of every page is powered
            by our AI Vastu expert. Ask it anything about directions, remedies,
            or room placement — it draws on classical Vastu knowledge to give
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            >
              <Link href="/vaastu-score">Get Your Free Vastu Score</Link>
            </Button>
            <Button
              asChild
              size="lg"
